  ...
  return stitchSchemas({
    ...
    /*  {
      ...
      /*
      {
        ...
        schema: await introspectSchema(wordpresssiteApiExec, adminContext),
        executor: wordpresssiteApiExec,
        transforms: [
      ...
      */
      {
        ...
        // In this case, transforms may be used to integrate the third-party schema
        // with remapped names (and/or numerous other transformations).
        schema: await introspectSchema(pwaStudioDemoMagentoApiExec, adminContext),
        executor: pwaStudioDemoMagentoApiExec,
      },
      {
